...
AS3935::AS3935(int csPin, int irq)
{
...
uint8_t AS3935::_SPITransfer2(uint8_t high, uint8_t low)
{
...
uint8_t AS3935::_rawRegisterRead(uint8_t reg)
{
...
{
    int target = 3125, currentcount = 0, bestdiff = 0xFFFFFFFF, currdiff = 0;
